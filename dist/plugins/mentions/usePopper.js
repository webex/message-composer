...
export default (({
  ...
  const popperInstance = useRef(); // manage the popper instance lifecycle
  ...
  }, [arrowRef && arrowRef.current, referrenceRef.current, popperRef.current, placement, positionFixed, modifiers]);
  useEffect(() => {
